...
public class InterviewServiceImplTest {
	...
	public void listAllInterviewDetails()
	{
		...
		.clientName("TCS").communication(80).enthusiasm(100).build();
	...
	public void updateToInterviewDetails()
	{
        ...
        assertEquals(interview.getInterviewId() + " Details Updated Successfully!" ,interviewService.updateToInterviewDetails(interview));
	...
	public void saveInterviewNew()
	{
		...
		Optional<InterviewModelDTO> interview = Optional.ofNullable(InterviewModelDTO.builder().candidate_id(14).candidateName("Sunali").clientName("ABC").communication(98).interviewId(1).rounds(2).position_id(2).build());



        Interview interviewM = Interview.builder().interviewId(1000).rounds(2).candidateName("Sunali").clientName("TCS").communication(80).enthusiasm(100).build();

...
public class EmployeeOperationController {
	...
	public ResponseEntity<String> uploadDocument(@PathVariable int empId, @PathVariable int docTypeId,
	...
	public ResponseEntity<String> deleteDocument(@PathVariable int empId, @PathVariable int docTypeId)
			throws IOException {
		try {
			LOGGER.info("EmployeeDocumentService:employee:addDocument info level log message");
	...
	public ResponseEntity<String> getUserProfilePicture(@PathVariable("employeeId") int employeeId,
			HttpServletResponse resp) {

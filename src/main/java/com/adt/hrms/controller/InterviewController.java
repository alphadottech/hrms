...
public class InterviewController {
	...
	public ResponseEntity<String> updateInterviewDetailByInterviewIDAndRound(@RequestBody InterviewModelDTO intwDTO) {
		...
		LOGGER.info(
				"EmployeeService:InterviewController:updateInterviewDetailByInterviewIDAndRound info level log message");

		int interviewIdFromReq = intwDTO.getInterviewId();
		int roundIdFromReq = intwDTO.getRounds();

		Interview interviewFromDB = interviewService.getInterviewDetailByInterviewIdAndRound(interviewIdFromReq,
				roundIdFromReq);
		...
		if (interviewFromDB == null)
			...
			Interview updatedInterviewDetail = interviewService
					.updateInterviewDetailByInterviewIdAndRound(interviewIdFromReq, roundIdFromReq, intwDTO);
